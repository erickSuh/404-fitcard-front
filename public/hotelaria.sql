...
INSERT INTO `gerente` VALUES (1,'André Fernando','andfer@email.com','andfertop');
...
INSERT INTO `hospede` VALUES (1,'Pedro Almeida','pedro@gmail.com','batata',345.7,0),(2,'Roger Nunes','roger@gmail.com','senha',1002.47,1),(3,'Cláudia Carvalho','claudia@gmail.com','123qwe',180,0),(4,'Andressa Oliveira','andressa@gmail.com','123456',562,1),(5,'Robson Fortado','robson@gmail.com','covid',140,0);
...
INSERT INTO `quarto` VALUES (11,'Standart',0),(12,'Standart',0),(13,'Standart',0),(14,'Luxo',0),(21,'Standart',0),(22,'Standart',0),(23,'Standart',0),(24,'Luxo',0);
...
CREATE TABLE `reserva` (
  ...
  `Cod_hospede` int DEFAULT NULL,
  `Cod_quarto` int DEFAULT NULL,
  PRIMARY KEY (`Id_reserva`),
  KEY `Cod_hospede` (`Cod_hospede`),
  KEY `Cod_quarto` (`Cod_quarto`),
  CONSTRAINT `reserva_ibfk_1` FOREIGN KEY (`Cod_hospede`) REFERENCES `hospede` (`Id_hospede`),
  CONSTRAINT `reserva_ibfk_2` FOREIGN KEY (`Cod_quarto`) REFERENCES `quarto` (`Id_quarto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `servico_extra` VALUES (1001,'Lavanderia',40,0),(1002,'Sauna',20,0),(1003,'Repetir Refeição',50,0),(1004,'Limpeza de Extra de Quarto',30,0),(1005,'Academia',35,0),(1006,'Spa',70,0);
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2020-11-05 01:22:42',NULL),('diagnostics.include_raw','OFF','2020-11-05 01:22:42',NULL),('ps_thread_trx_info.max_length','65535','2020-11-05 01:22:42',NULL),('statement_performance_analyzer.limit','100','2020-11-05 01:22:42',NULL),('statement_performance_analyzer.view',NULL,'2020-11-05 01:22:42',NULL),('statement_truncate_len','64','2020-11-05 01:22:42',NULL);
...
-- Dump completed on 2020-11-05  8:19:39
